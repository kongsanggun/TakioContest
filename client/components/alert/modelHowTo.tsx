    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-10 flex items-center justify-center w-full h-screen text-center duration-150 bg-scroll bg-black bg-opacity-30">
            ...
            <div className="bg-white rounded-lg w-[70vw] h-[calc(70vw/3*2 + 40px)] max-w-[720px] px-2 sm:px-5 py-2 sm:py-5 drop-shadow-xl flex flex-col fixed justify-center items-center">
                <div className="w-full h-auto text-gray-500 font-['SDKukdetopokki-Lt'] flex flex-col items-center">
                    <Image src={HowToSeeNumber} className='w-[80%] h-[auto] max-h-[480px]' alt='북번호를 확인하는 방법'></Image>
                    <div className='flex flex-col items-start w-auto h-auto mt-8 text-sm text-left sm:text-base'>
                        <div className='w-full h-auto mb-2'>- <a className={seglink} href="https://donderhiroba.jp" target="_blank" rel="noopener noreferrer">동더히로바</a>에 접속하여 로그인을 진행한다. </div>
