        ...
        <header>
            <div className="w-full h-16 sm:h-20 flex items-center justify-between border-b-[1.5px] border-b-[#BEC0D7]">
                ...
                <div className='w-auto h-full text-[#121316] flex items-center justify-center font-["SDKukdetopokki-Lt"] font-extrabold duration-200'>
                    <Link className="w-auto h-full text-xl sm:text-2xl mr-10 sm:mr-16 flex items-center justify-center hover:text-[#BEC0D7] hover:border-b-8 duration-150" href="/">Main</Link>
                    <Link className="w-auto h-full text-xl sm:text-2xl mr-10 sm:mr-16 flex items-center justify-center hover:text-[#BEC0D7] hover:border-b-8 duration-150" href="/ranking">Ranking</Link>
                    <Link className="w-auto h-full text-xl sm:text-2xl flex items-center justify-center hover:text-[#BEC0D7] hover:border-b-8 duration-150" href="/entry">접수하기</Link>
                </div>
