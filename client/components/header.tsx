    ...
    return (
        <header>
            <div className="w-full h-20 flex items-center justify-between border-b-[0.5px] border-b-[#BEC0D7]">
                <div className='w-[0vw] sm:w-[10vw] h-full'> </div>
                <div className='w-[80vw] text-base sm:text-2xl h-full text-[#121316] flex items-center justify-center font-["SDKukdetopokki-Lt"] duration-200'>
                    <Link className={linkClass} href="/">Main</Link>
                    <Link className={linkClass} href="/ranking">Ranking</Link>
                    <Link className={linkClass} href="/entry">접수하기</Link>
                </div>
                <div className='w-[10vw] min-w-[40px] h-full text-[#121316] flex items-center justify-center' onClick={Admin}>
